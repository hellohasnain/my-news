...
const Header = () => {
  return (
    ...
    >
      <div className="bg-[#e1332c] bg-secondary hidden md:flex md:text-2xl text-white font-extrabold pb-10 w-full mx-auto border-b items-center justify-between py-10 md:px-[10%] lg:px-[20%] select-none">
      ...
      <div className="md:hidden bg-[#e1332c] bg-secondary text-white text-center pt-5 select-none">
        <Link
          href="/"
